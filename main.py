...
def equals():
    ...
    try:
        ...
        equation_label.set("synthax error")
        equation_text = ""
...
decimal = Button(frame, text=".", width=9, height=4, command=lambda :button_press("."))
decimal.grid(row=3,column=1)

clear = Button(window, text="clear",width=9, height=4, command=clear)
clear.pack()
